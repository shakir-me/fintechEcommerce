                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <th class="column" style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                <tr>
                                                                    <td class="img m-center" style="font-size:0pt; line-height:0pt; text-align:left;"><img src="https://cdn.logo.com/hotlink-ok/logo-social.png" width="100" height="44" border="0" alt="" /></td>
                                                                </tr>
                                                            </table>
                                                        </th>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                    <tr>
                                                        <td style="color:#000000; font-family:'Ubuntu', Arial,sans-serif; font-size:14px; line-height:20px; padding-bottom:10px;">
                                                            <p><span style="font-weight: bold; text-decoration: underline;">Subject : {{ $emailContent['email_subject'] }}</span></p>
                                                            @foreach($emailContent['product_url'] as $link)
