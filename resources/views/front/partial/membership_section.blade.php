				...
				<div class="col-12 col-sm-6 col-lg-4 col-xl-3">
					<div class="membership__item Reseller">
						<div class="membership__top">
							<img
								src="{{ asset('frontend/') }}/img/membership-icon.png"
					...
					<div class="membership__item Reseller">
						<div class="membership__top">
							...
							<img
								...
								alt=""
							/>
							<h2 class="heading mb-1">Vip Mebership</h2>
							<h3 class="heading d-flex flex-column align-items-center">
				...
				<div class="col-12 col-sm-6 col-lg-4 col-xl-3">
					<div class="membership__item Reseller">
						<div class="membership__top">
							<img
								src="{{ asset('frontend/') }}/img/membership-icon.png"
								class="membership__icon membership__icon-1 mb-2"
								alt=""
							/>
							<img
								src="{{ asset('frontend/') }}/img/membership-icon-hove.png"
								class="membership__icon membership__icon-2 mb-2"
								alt=""
							/>
							<h2 class="heading mb-1">Premium Membership</h2>
							<h3 class="heading d-flex flex-column align-items-center">
