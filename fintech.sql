...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 22, 2023 at 02:18 PM
...
--
-- Table structure for table `about_ones`
--

CREATE TABLE `about_ones` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `about_ones`
--

INSERT INTO `about_ones` (`id`, `title`, `image`, `details`, `created_at`, `updated_at`) VALUES
(1, 'Increased Revenue Stream', '93284png', 'We’ll Reimburse The Cost Of Any Lost MonkProtected Orders.', '2023-02-20 11:59:34', '2023-02-20 12:04:05'),
(2, 'Increased Revenue Stream', '79869png', 'We’ll Reimburse The Cost Of Any Lost MonkProtected Orders.', '2023-02-20 12:00:46', '2023-02-20 12:04:48'),
(3, 'Higher Customer Retention', '7476png', 'We’ll Reimburse The Cost Of Any Lost MonkProtected Orders.\r\n\r\n.', '2023-02-20 12:01:41', '2023-02-20 12:01:41');

-- --------------------------------------------------------

--
-- Table structure for table `about_twos`
--

CREATE TABLE `about_twos` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `details` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
--
-- Dumping data for table `about_twos`
--

INSERT INTO `about_twos` (`id`, `title`, `details`, `created_at`, `updated_at`) VALUES
(1, 'BECOME A PERFECT TRADERs', '<div>Lorem Ipsum Dolor Sit Amet Consectetur. Sit Nunc Id Mauris Nibh Bibendum Tellus Nec Sit. Orci Proin Dolor Ipsum Mi Et Sit Condimentum Pulvinar. Purus Facilisis Eget Sed Dictum Donec Commodo. Enim Pellentesque Ac Eget Tristique. Aliquet Mattis Aliquam Id Aliquet. Iaculis Nunc Nisi Mus Egestas Euismod At</div><div><br></div><div>FIND THE RIGHT PRODUCT FOR YOU </div>', '2023-02-20 12:30:53', '2023-02-20 12:34:07'),
(2, 'GET LEGITIMATE SOFTWARES', '<p>Lorem Ipsum Dolor Sit Amet Consectetur. Sit Nunc Id Mauris Nibh Bibendum Tellus Nec Sit. Orci Proin Dolor Ipsum Mi Et Sit Condimentum Pulvinar. Purus Facilisis Eget Sed Dictum Donec Commodo. Enim Pellentesque Ac Eget Tristique. Aliquet Mattis Aliquam Id Aliquet. Iaculis Nunc Nisi Mus Egestas Euismod At</p><p><br></p><p>GET STARTED&nbsp;</p>', '2023-02-20 12:31:22', '2023-02-20 12:31:22');
...
INSERT INTO `home_pages` (`id`, `title`, `details`, `created_at`, `updated_at`) VALUES
(15, 'Fill In The Request Form', '<p>Complete The Simple Software Request Form<br></p>', '2023-02-22 11:03:00', '2023-02-22 11:03:00'),
(16, 'Pay Development Fee', '<p>Your Development Fee Would Be 100% Refunded, If Your Strategy Is Not Approved.<br></p>', '2023-02-22 11:04:38', '2023-02-22 11:04:38'),
(17, 'Wait A Little Bit', '<p>Development May Take Some Time, Depending On The Strategy And Optimization Parameters<br></p>', '2023-02-22 11:05:15', '2023-02-22 11:05:15'),
(18, 'Download And Test', '<p>A Meeting Would Be Scheduled To Show You Your New Strategy, Which You Can Download And Share<br></p>', '2023-02-22 11:05:38', '2023-02-22 11:05:38');
...
INSERT INTO `market_places` (`id`, `title`, `image`, `details`, `created_at`, `updated_at`) VALUES
(1, 'Web Content Management', '46801png', 'Donec Gravida Est Ut Velit Fringilla, Et Venenatis Nisi Euismod. Aenean Est Turpis, Rhoncus Quis Scelerisque', '2023-02-16 06:42:02', '2023-02-16 06:42:02'),
(2, 'Digital Asset Management', '2235png', 'Donec Gravida Est Ut Velit Fringilla, Et Venenatis Nisi Euismod. Aenean Est Turpis, Rhoncus Quis Scelerisque Ac, Eleifend Quis Lorem', '2023-02-16 06:42:42', '2023-02-16 06:42:42'),
(3, 'Headless CMS', '62743png', '<span style=\"color: rgb(68, 68, 68); font-family: \"Open Sans\", sans-serif; font-size: 16px; letter-spacing: normal; text-align: center; text-transform: capitalize;\">Donec Gravida Est Ut Velit Fringilla, Et Venenatis Nisi Euismod. Aenean Est Turpis, Rhoncus Quis</span>', '2023-02-16 06:43:13', '2023-02-16 06:58:51');
...
(30, '2023_02_16_114307_create_market_places_table', 8),
(31, '2023_02_16_140032_create_home_pages_table', 9),
(32, '2023_02_20_174143_create_about_ones_table', 10),
(33, '2023_02_20_180529_create_about_twos_table', 11),
(34, '2021_08_15_113006_create_crypto_payments_table', 12),
(35, '2023_02_22_115902_create_web_sites_table', 12),
(36, '2023_02_22_165429_create_reques_table', 13);
...
CREATE TABLE `orders` (
  ...
  `subscribe_id` text COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `orders` (`id`, `user_id`, `order_no`, `total_qty`, `total_price`, `coupon_amount`, `payment_status`, `payment_method`, `coupon`, `created_at`, `updated_at`, `refund`, `balance`, `name`, `email`, `subscribe_id`) VALUES
(16, 2, '230214040129', 3, '705.00', 0, NULL, 'Paypal', '', '2023-02-14 10:13:00', '2023-02-14 10:13:00', '70.5', NULL, NULL, NULL, NULL),
(17, 2, '230214041410', 3, '705.00', 0, NULL, 'Paypal', '', '2023-02-14 10:14:25', '2023-02-14 10:14:25', '70.5', NULL, NULL, NULL, NULL),
(18, 2, '230214041518', 3, '705.00', 0, NULL, 'Paypal', '', '2023-02-14 10:15:39', '2023-02-14 10:15:39', '70.5', NULL, NULL, NULL, NULL),
(19, 2, '230214041653', 3, '705.00', 0, NULL, 'Paypal', '', '2023-02-14 10:17:10', '2023-02-14 10:17:10', '70.5', NULL, NULL, NULL, NULL),
(20, 2, '230220044953', 2, '500.00', 0, NULL, 'Paypal', '', '2023-02-20 10:50:09', '2023-02-20 10:50:09', '50', NULL, NULL, NULL, 'Basic Membership'),
(21, 2, '230220045326', 2, '700.00', 0, NULL, 'Paypal', '', '2023-02-20 10:53:43', '2023-02-20 10:53:43', '70', NULL, 'shakir khan', 'user@gmail.com', 'Basic Membership'),
(22, 2, '230220045728', 2, '700.00', 0, NULL, 'Paypal', '', '2023-02-20 10:57:42', '2023-02-20 10:57:42', '70', NULL, 'shakir khan', 'user2@gmail.com', 'Basic Membership');
...
(12, 19, 'Semi-Auto Computer', '1', '300', 300, '2023-02-14 10:17:10', '2023-02-14 10:17:10', 1, 4),
...
(15, 20, 'New App  Mobile', '1', '200', 200, '2023-02-20 10:50:09', '2023-02-20 10:50:09', 1, 9),
(16, 20, 'Semi-Auto Computer', '1', '300', 300, '2023-02-20 10:50:09', '2023-02-20 10:50:09', 1, 4),
(17, 21, 'Operating Systems Dell', '1', '400', 400, '2023-02-20 10:53:43', '2023-02-20 10:53:43', 1, 5),
(18, 21, 'Semi-Auto Computer', '1', '300', 300, '2023-02-20 10:53:43', '2023-02-20 10:53:43', 1, 4),
(19, 22, 'New Software Livewire', '1', '500', 500, '2023-02-20 10:57:42', '2023-02-20 10:57:42', 1, 8),
(20, 22, 'New App  Mobile', '1', '200', 200, '2023-02-20 10:57:42', '2023-02-20 10:57:42', 1, 9);
...
(6, 4, 'very Nice Product', 12, '2023-02-20 07:35:23', '2023-02-20 07:35:23'),
(7, 3, 'tgghgg', 12, '2023-02-20 08:11:06', '2023-02-20 08:11:06');
...
INSERT INTO `socials` (`id`, `icon_class`, `link`, `created_at`, `updated_at`) VALUES
(2, 'fracebook', 'https://www.facebook.com/shakirnr/', '2023-02-20 05:13:07', '2023-02-20 05:13:07');
...
(3, 'admin@gmail.com', '2023-02-16 07:48:03', '2023-02-16 07:48:03');
...
(2, 'user', 'shakir khan', 'user@gmail.com', '01740125204', 'Dhaka Mirpur', 'backend/assets/images/63e0d9f38bbd4.webp', 1740125204, '2023-02-02 06:27:48', '$2y$10$WpbHdU7NZXq85l.WRVpS2u0NWt6mCPU.ZMIqsTuzz3UJHKtakGRpS', NULL, '2023-02-02 05:08:41', '2023-02-20 10:57:42', NULL, NULL, '3'),
...
CREATE TABLE `web_sites` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `details` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `market_details` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `latest_product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `latest_product_des` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `free_product_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `free_product_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `member_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `member_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `software_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `software_des` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tesmonial` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `available_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `available_desc` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `market_title` varchar(199) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `web_sites` (`id`, `title`, `details`, `market_details`, `latest_product_title`, `latest_product_des`, `free_product_title`, `free_product_des`, `member_title`, `member_des`, `software_title`, `software_des`, `tesmonial`, `contact_title`, `contact_desc`, `available_title`, `available_desc`, `image`, `created_at`, `updated_at`, `market_title`) VALUES
(1, 'Optimised Trading Software And System For Any Platform', 'Discover Thousands Of Easy To Set Up, Expert Advisors, Indicators Made By World Class Developers', 'Marketplace In The World', 'Latest Added', 'New Product Add', 'Free Items', 'There Are Always Free Software On Trading Kernel For You To Enjoy. Forex Robots, Must Use Scripts, Profit Lock Systems And Lots More, Get The While You Can!', 'Fintech Membership', 'Enjoy Millions Of Expert Advisors, Indicators & More With Fintech', 'Request For Any Custom Trading Software', 'If You Would Like To Enquire About The Availability Of Any Trading Software, Strategy Or System, Simply Let Us Know!', 'What Our Client Say', 'Automate Your Personal Strategy', 'Contract Us To Automate Your Personal Strategy, Or Indicator For MT4, MT5 And Binance. You Can Also Request For A Cracked Software', 'Available 24/7', '<div>We Are Always Available 24/7 To Respond To Queries Or Issues, Please Ensure To Check Our FAQ’s To Avoid Duplicate Questions, If You Need Immediate Help You Can Click The Chat Button At The Bottom Right To Initiate Live Support With Our Support Team.</div><div><br></div><div>Queries Will Be Responded To Based On First Come, First Serve And The Moment You Send Us A Contact Request You Will Be Added To The Que And An Support Ticket Will Be Automatically Open For You.</div>', '74373png', '2023-02-22 08:03:05', '2023-02-22 10:39:55', 'We Are The Largest Trading Software');
...
--
-- Indexes for table `about_ones`
--
ALTER TABLE `about_ones`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `about_twos`
--
ALTER TABLE `about_twos`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `about_ones`
--
ALTER TABLE `about_ones`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `about_twos`
--
ALTER TABLE `about_twos`
...
--
-- AUTO_INCREMENT for table `web_sites`
--
ALTER TABLE `web_sites`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
